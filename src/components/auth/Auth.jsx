...
export default function Auth() {
    ...
    const handleSubmit = (event)=>{
        ...
        axios.post(`${process.env.REACT_APP_API_URL}user/sign-in`, data)
        .then(res=>{
            if(res.status == 200){
            ...
            <div className="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-floating mb-4">
                        <input type="password" className="form-control" name='password' id="floatingPassword" placeholder="Password" onChange={handleChange}/>
